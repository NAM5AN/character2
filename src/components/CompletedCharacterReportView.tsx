    ...
    <div id="paid-detail-report" style={{marginTop:38,scrollMarginTop:90}}>
      ...
      {isPaged?<>
        ...
        {reportPage===3&&<>
          ...
          <NarrativeSection index={6} title="통합 리포트" text={analysis.integratedReport} tags={analysis.integratedReportTags??analysis.sectionTags?.integratedReport} tldr={analysis.integratedReportTldr}/>
        </>}
