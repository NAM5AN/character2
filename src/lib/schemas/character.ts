...
export const characterDraftSchema = z.object({
  ...
  traits: z.record(z.string(), z.union([z.number().min(0).max(100), z.string(), z.boolean(), z.null()])),
  relationshipTraits: z.record(z.string(), z.union([z.number().min(0).max(100), z.string(), z.boolean(), z.null()])),
