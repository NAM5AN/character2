...
export const detailAnalysisGenerationSchema=z.object({outerSelf:z.string().min(140).max(700),innerSelf:z.string().min(140).max(700),coreValues:reportListSchema,desires:reportListSchema,fears:reportListSchema,conflictStyle:z.string().min(140).max(700),affectionStyle:z.string().min(140).max(700),misunderstoodPoints:evidenceBackedListSchema,contradictions:evidenceBackedListSchema,interestingPoints:reportListSchema,detailedReport:z.string().min(700).max(2000)});
...
export const finalAnalysisSchema=z.object({oneLineSummary:z.string(),summary:analysisTypeSummarySchema.optional(),outerSelf:z.string(),innerSelf:z.string(),coreValues:z.array(z.string()),desires:z.array(z.string()),fears:z.array(z.string()),conflictStyle:z.string(),affectionStyle:z.string(),misunderstoodPoints:z.array(z.string()),contradictions:z.array(z.string()),interestingPoints:z.array(z.string()),detailedReport:z.string().optional()});
