  ...
  return <main>
    ...
    <section className="container section">
      <div className="feature-grid">
        ...
        <article className="feature"><span className="num">03</span><h3>캐릭터 저장</h3><p>캐릭터 이름과 오너명으로 분석 결과를 저장해 나중에 다시 불러오고 다른 프로젝트에서 재사용합니다.</p></article>
      </div>
    </section>
    <section id="lookup" className="container section">
      <div className="card two-col">
        <div><div className="eyebrow">Load character</div><h2 style={{marginTop:10}}>이미 분석한 자캐가 있나요?</h2><p className="muted">저장할 때 사용한 캐릭터 이름과 오너명을 입력하면 리포트를 다시 불러올 수 있어요.</p></div>
