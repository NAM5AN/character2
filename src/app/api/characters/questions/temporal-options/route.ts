...
export async function POST(request:Request){
  try{
    ...
    const result=await withAiUsageContext({sessionId:body.draft.usageSessionId,characterName:body.draft.basicProfile.name,stage:`temporal_options_${body.question.order}`},()=>askOpenAIJson({
